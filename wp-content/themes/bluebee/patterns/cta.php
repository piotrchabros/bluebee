 ...
 */
?>
<!-- wp:group {"tagName":"section","align":"full","className":"bb-cta bb-section","id":"contact","style":{"color":{"background":"#1B45E8","text":"#FFFFFF"},"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80","left":"var:preset|spacing|60","right":"var:preset|spacing|60"}}},"layout":{"type":"constrained","wideSize":"1280px"}} -->
<section class="wp-block-group alignfull bb-cta bb-section" id="contact" style="background-color:#1B45E8;color:#FFFFFF;padding:var(--wp--preset--spacing--80) var(--wp--preset--spacing--60)">

	<!-- wp:columns {"style":{"spacing":{"blockGap":"6rem"}}} -->
	<div class="wp-block-columns">
		...
		<div class="wp-block-column bb-cta__left bb-animate" style="flex-basis:50%">
			...
			<p style="font-family:var(--wp--preset--font-family--heading);font-size:0.72rem;font-weight:600;letter-spacing:0.18em;text-transform:uppercase;color:rgba(255,255,255,0.55);margin-bottom:1.25rem"><?php echo esc_html__( 'Start a Project', 'bluebee' ); ?></p>
			<!-- /wp:paragraph -->

			<!-- wp:heading {"level":2,"style":{"typography":{"fontFamily":"var(--wp--preset--font-family--heading)","fontWeight":"800","fontSize":"clamp(2.5rem,5vw,4.5rem)","lineHeight":"0.93","letterSpacing":"-0.035em"},"color":{"text":"#FFFFFF"},"spacing":{"margin":{"bottom":"2rem"}}}} -->
			<h2 class="wp-block-heading" style="font-family:var(--wp--preset--font-family--heading);font-size:clamp(2.5rem,5vw,4.5rem);font-weight:800;line-height:0.93;letter-spacing:-0.035em;color:#FFFFFF;margin-bottom:2rem"><?php echo esc_html__( 'Ready to grow your brand?', 'bluebee' ); ?></h2>
			<!-- /wp:heading -->
			...
			<p style="font-size:1.1rem;line-height:1.65;color:rgba(255,255,255,0.75);margin-bottom:3rem"><?php echo esc_html__( 'Tell us about your project. We typically respond within one business day — no commitment, no pressure.', 'bluebee' ); ?></p>
			<!-- /wp:paragraph -->
			...
			<div class="wp-block-group bb-cta__contact-info" style="gap:1.25rem">
				...
				<p style="font-family:var(--wp--preset--font-family--heading);font-size:0.8rem;font-weight:600;letter-spacing:0.08em;text-transform:uppercase;color:rgba(255,255,255,0.5)"><?php echo esc_html__( 'Or reach us directly', 'bluebee' ); ?></p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph {"style":{"typography":{"fontSize":"1.1rem","fontFamily":"var(--wp--preset--font-family--heading)","fontWeight":"700"},"color":{"text":"#FFFFFF"}}} -->
				<p style="font-size:1.1rem;font-family:var(--wp--preset--font-family--heading);font-weight:700;color:#FFFFFF"><a href="mailto:hello@bluebee.agency" style="color:inherit;text-decoration:none">hello@bluebee.agency</a></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
