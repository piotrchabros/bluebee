...
<section class="wp-block-group alignfull bb-hero bb-section has-background" id="home" style="background-color:var(--wp--preset--color--cream);padding-top:0;padding-right:0;padding-bottom:0;padding-left:0;margin-top:0">
	...
	<div class="wp-block-group bb-hero__inner" style="padding-top:10vh;padding-right:var(--wp--preset--spacing--60);padding-bottom:10vh;padding-left:var(--wp--preset--spacing--60)">
		...
		<!-- wp:group {"className":"bb-hero__bottom bb-animate bb-animate--delay-2","layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"center"}} -->
		<div class="wp-block-group bb-hero__bottom bb-animate bb-animate--delay-2">

			<!-- wp:paragraph {"style":{"typography":{"fontSize":"1.2rem","lineHeight":"1.65"},"color":{"text":"var:preset|color|gray"},"spacing":{"margin":{"bottom":"0","top":"0"}}}} -->
			<p class="has-text-color" style="font-size:1.2rem;line-height:1.65;color:var(--wp--preset--color--gray);margin-top:0;margin-bottom:0"><?php echo esc_html__( 'We partner with ambitious companies to build bold strategies, distinctive brand identities, and campaigns that move markets. No fluff — just results that stick.', 'bluebee' ); ?></p>
			<!-- /wp:paragraph -->
